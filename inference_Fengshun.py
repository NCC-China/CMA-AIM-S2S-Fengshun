...
parser.add_argument('--model', type=str,default="*/Fengshun_cra40.onnx", help="Fengshun_cra40 onnx model file")
parser.add_argument('--input', type=str, default="data/input.nc", help="The input netcdf data file")
parser.add_argument('--device', type=str, default="cuda", help="The device to run Fengshun model")
...
if __name__ == "__main__":
    ...
    print(f'Load Fengshun ...')       
    start = time.perf_counter()
    model = load_model(args.model, args.device)
    input_names = [input.name for input in model.get_inputs()]
    print(f'Load Fengshun take {time.perf_counter() - start:.2f} sec')
